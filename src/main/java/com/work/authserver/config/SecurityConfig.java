...
public class SecurityConfig {
     ...
     * keeping strict redirect-URI (https/loopback) and jwk validation.
     */
        ...
        http
                .oauth2AuthorizationServer(authorizationServer -> {
                    authorizationServer
                            ...
                            // registration is unauthenticated — gate it behind a trusted proxy / network
                            // policy in production. Registered clients live in memory and are lost on
                            // restart (swap for a persistent repository before production).
                            .clientRegistrationEndpoint(clientRegistration -> clientRegistration
                                    ...
                                    // SIMPLE scope validator while keeping strict redirect-URI (https/
                                    // loopback) + jwk validation.
